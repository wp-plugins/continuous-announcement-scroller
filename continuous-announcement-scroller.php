...
Description: This plug-in will create a vertical scroll continuous announcement for your wordpress website, <a href="http://www.gopipulse.com/work/" target="_blank">Live demo</a>.
Author: Gopi.R
Version: 9.0
...
function cas_install() 
{
	...
	if($wpdb->get_var("show tables like '". WP_cas_TABLE . "'") != WP_cas_TABLE) 
	{
		...
		$sSql = $sSql . "VALUES ('This is simply dummy announcement text.','http://www.gopipulse.com/work/', '1', 'YES', '0000-00-00 00:00:00');";
		$wpdb->query($sSql);
		$sSql = "INSERT INTO `". WP_cas_TABLE . "` (`cas_text`,`cas_link`, `cas_order`, `cas_status`, `cas_date`)"; 
		$sSql = $sSql . "VALUES ('To updae the setting use plugin link under wp setting tab.','http://www.gopipulse.com/work/', '2', 'YES', '0000-00-00 00:00:00');";
		$wpdb->query($sSql);
		$sSql = "INSERT INTO `". WP_cas_TABLE . "` (`cas_text`,`cas_link`, `cas_order`, `cas_status`, `cas_date`)"; 
		$sSql = $sSql . "VALUES ('Click here to see more help for this wp plugin.','http://www.gopipulse.com/work/', '3', 'YES', '0000-00-00 00:00:00');";
		$wpdb->query($sSql);
	}
...
function cas_control() 
{
	...
	echo 'click here</a></p>';
	?>
	<a target="_blank" href='http://www.gopipulse.com/work/2010/09/04/continuous-announcement-scroller/'>Check official website for live demo</a><br />
	<?php
}
